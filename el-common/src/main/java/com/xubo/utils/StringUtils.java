...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    private static final Logger log = LoggerFactory.getLogger(com.xubo.utils.StringUtils.class);
    ...
    static {
        SpringContextHolder.addCallBacks(() -> {
            com.xubo.utils.StringUtils.ipLocal = SpringContextHolder.getProperties("ip.local-parsing", false, Boolean.class);
            if (ipLocal) {
                /*
                 * 此文件为独享 ，不必关闭
                 */
